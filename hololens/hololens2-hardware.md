...
ms.locfileid: "113636865"
---
# <a name="about-hololens-2"></a>Cerca de HoloLens 2

![HoloLens vista lateral 2](images/hololens2-breakdown.png)

Microsoft HoloLens 2 é um computador holográfico sem amarras.  Refina a jornada de computação holográfica iniciada por HoloLens (1ª geração) para proporcionar uma experiência mais confortável e imersiva, emparelhada com mais opções para colaborar na realidade mista. HoloLens 2 corre no [Windows O SISTEMA Holográfico,](hololens-release-notes.md)que se baseia num "sabor" de Windows 10, que fornece aos utilizadores, administradores e desenvolvedores uma plataforma robusta, performante e segura. 
...
Uma conta de utilizador é necessária para utilizar HoloLens 2.

## <a name="hololens-components"></a>componentes HoloLens

- **Viseira.** Contém os sensores e ecrãs HoloLens. Pode rodar a viseira enquanto usa o HoloLens.
- **Fita na cabeça.** Para colocar a HoloLens, utilize a roda de regulação para expandir a fita da cabeça. Com a HoloLens no lugar, aperte a roda de regulação virando para a direita, até que a fita da cabeça fique confortável.
- **Botões de brilho**. Ao usar o HoloLens, os botões de brilho estão no lado esquerdo da viseira perto do seu templo.
- **Botões de volume**. Ao usar o HoloLens, os botões de volume estão no lado direito da viseira perto do seu templo.
- **Botão de alimentação**. Ao usar o HoloLens, o botão de alimentação encontra-se no lado direito da tampa exterior traseira.
- **Porta USB-C**. Ao usar o HoloLens, a porta USB-C está localizada no lado direito da tampa exterior traseira por baixo do botão de alimentação.
...
| Loja Microsoft | O [Microsoft Store](https://www.microsoft.com) é a sua fonte de aplicações e jogos que funcionam com HoloLens.|
...
| OneDrive | [OneDrive](https://www.microsoft.com/p/onedrive/9wzdncrfj1p3?activetab=pivot:overviewtab) permite-lhe aceder e editar os seus ficheiros de todos os seus dispositivos em qualquer lugar.  |
...
| Definições | A aplicação Definições é o local onde você personaliza como Windows Holographic funciona em detalhe.  |
| Sugestões | [Sugestões](https://www.microsoft.com/p/microsoft-tips/9wzdncrdtbjj?activetab=pivot:overviewtab) permite-lhe dominar coisas surpreendentes e menos conhecidas que pode fazer em Windows Holographic. |
...
Microsoft HoloLens 2 vem com uma [garantia](https://support.microsoft.com/topic/warranties-extended-service-plans-and-terms-conditions-for-your-device-eedf7a23-84a7-1a47-480b-0e10503eedf5)limitada padrão . 
...
> [Comparar HoloLens 2 Edições](hololens2-options.md)

> [!div class="nextstepaction"]
> [Configurar e iniciar o seu HoloLens 2](hololens2-setup.md)
