...
## [Cerca de HoloLens 2](hololens2-hardware.md)
## [O que HoloLens 2 pode fazer por si?](hololens-commercial-features.md)
...
#### [HoloLens 2 FaQs de edição industrial](hololens2-industrial-edition-faq.md)
### [Edição de desenvolvimento](hololens2-options-dev-edition.md)
#### [HoloLens 2 Edição de Qir](hololens2-development-edition-faq.yml)
...
### [Atualizar HoloLens](hololens-update-hololens.md)
## Uso diário
### Navegue pela interface holográfica Windows
#### [Use a casa de menu Iniciar e realidade mista](holographic-home.md)
#### [Use a sua voz para operar HoloLens](hololens-cortana.md)
#### [Encontre, abra e guarde ficheiros sobre HoloLens](holographic-data.md)
...
#### [Ligação para Celular e 5G](hololens-cellular.md)
### [HoloLens bateria 2 e carregamento](hololens2-charging.md)
### [HoloLens 2 PERGUNTAS frequentes de ajuste e conforto](hololens2-fit-comfort-faq.md)
### [HoloLens 2 faq de limpeza](hololens2-maintenance.md)

# Implantação HoloLens 2
## [Cenários de implementação comuns](hololens-requirements.md)
## [Implantação de HoloLens 2](hololens-core-components.md)
...
### [Partilhe HoloLens com várias pessoas](hololens-multiple-users.md)
## Segurança
...
### [HoloLens 2 Proteção de Privacidade e Dados](hololens2-privacy.md)
## Inscrição de Dispositivos
### [Inscreva-se HoloLens no MDM](hololens-enroll-mdm.md)
### [Windows Autopilot para o HoloLens 2](hololens2-autopilot.md) 
### [Inscreva-se no endereço MAC ambiente restrito Wi-Fi](mac-address-options.md)
...
### [Página Definições CSP e URIs para HoloLens](settings-uri-list.md)
...
## [Gerir atualizações de HoloLens](hololens-updates.md)

# Resolução de problemas
## [Dispositivo](hololens-troubleshooting.md)
## [Hologramas e interações](hololens-faq.md)
## [Apresentar](hololens2-display.md)
## [Dispositivos de implementação e gestão](hololens2-enterprise-troubleshooting.md#)
## [Ativar registos de diagnóstico](hololens-diagnostic-logs.md)
## [Reiniciar, reiniciar ou recuperar HoloLens 2](hololens-recovery.md)

# Recursos
## [Onde comprar HoloLens 2](hololens2-purchase.md)
...
## [Saiba mais sobre a Malha microsoft (pré-visualização)](/mesh/overview)
## HoloLens (1ª geração)
### Utilização pela primeira vez
...
#### [Configurar o seu HoloLens (1ª geração)](hololens1-start.md)
### Uso diário
#### [Use o clicker HoloLens (1ª geração)](hololens1-clicker.md)
...
#### [Reiniciar, reiniciar ou recuperar HoloLens (1ª geração)](hololens1-recovery.md)
