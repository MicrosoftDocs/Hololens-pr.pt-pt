...
Quer soluções implantadas em escala. Queremos levá-lo lá. Vamos primeiro falar sobre os passos para implementar dispositivos, portanto hologramas, para alcançar valor para o seu cenário de realidade mista alvo. Quer esteja a utilizar o D365 Remote Assist, Guides ou uma aplicação ativada pelo serviço de realidade mista Azure que criou - os nossos Cenários comuns de Implementação irão orientar a sua viagem.
...
* Wi-Fi redes são normalmente totalmente abertas aos serviços de internet e nuvem
...
* Níveis variados de configurações de bloqueio do dispositivo são aplicados com base em casos de utilização específico, desde o Quiosque de Aplicações Totalmente Abertos a Single App.
...
O guia Cloud Connected correspondente cobre como inscrever HoloLens 2 na gestão do dispositivo, aplicar licenças conforme necessário e validar que os seus utilizadores finais podem utilizar imediatamente o Remote Assist na configuração do dispositivo.
...
Este cenário é idêntico a uma implantação clássica para a maioria dos PCs Windows 10. HoloLens 2 é implementado para uso principalmente na rede corporativa com acesso a recursos corporativos internos. Os serviços de internet e cloud podem ser limitados. 
...
* Implantação em escala (Piloto e Produção) dentro do ambiente corporativo
...
* HoloLens 2 não suporta em instalações a aderir ou System Center Configuration Manager (SCCM). Só a Azure AD se junta ao MDM. Muitas empresas ainda hoje implantam PCs Windows 10 neste cenário como em dispositivos de ad instalações, geridos pela SCCM e que podem não ter a infraestrutura implantada/configurada para gerir dispositivos internos de Windows 10 através de soluções MDM baseadas na nuvem.
...
O guia Corporate Connected correspondente instrui como inscrever HoloLens 2 na gestão do dispositivo existente, aplicar licenças conforme necessário e validar que os seus utilizadores finais são capazes de operar um Guia Dinâmico 365, bem como usar a linha personalizada de aplicações empresariais, após a configuração do dispositivo.
...
* Não Gerido
* Conta de utilizador local para o insusição do dispositivo
